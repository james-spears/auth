...
#         fields = ["email"]
#         widgets = {
#             "email": forms.EmailInput(attrs={"class": FORM_CLASS, "placeholder": "Email"}),
#         }
...
#         queryset=Permission.objects.filter(codename__in=['add_event', 'change_event', 'delete_event', 'view_event']),
